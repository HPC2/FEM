...
run_experiment 0 1 "./seq_fem 1 1 10 cg $RESULT_NAME"
hostfile 4 0 0 0 0 0 0 0 $HOSTFILE_NAME
run_experiment 0 1 "mpirun -np 4 --hostfile $HOSTFILE_NAME mpi_fem 2 2 9 cg $RESULT_NAME"
hostfile 4 4 4 4 0 0 0 0 $HOSTFILE_NAME
run_experiment 0 1 "mpirun -np 16 --hostfile $HOSTFILE_NAME mpi_fem 4 4 8 cg $RESULT_NAME"
hostfile 4 4 4 4 4 4 4 4 $HOSTFILE_NAME
run_experiment 0 1 "mpirun -np 64 --hostfile $HOSTFILE_NAME mpi_fem 8 8 7 cg $RESULT_NAME"
